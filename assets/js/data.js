/* ============================================================================
   Marin & West — Site Data & Configuration
   ----------------------------------------------------------------------------
   THIS IS THE ONLY FILE YOU NEED TO EDIT TO REBRAND THE SITE.
   Change the agent name, phone, email, social links, stats, listings, etc.
   below. Everything on the site reads from this object.

   NOTE: This is a fictional brand built as a design preview. All names,
   numbers, addresses and emails are placeholders.
   ========================================================================== */
...
window.SITE = {
  ...
  agent: {
    ...
    credentials: "PREC* · Top 1% Victoria Real Estate Board",
    phone: "250-555-0142",
    phoneHref: "tel:+12505550142",
    email: "hello@marinandwest.ca",
    emailHref: "mailto:hello@marinandwest.ca",
    portrait:
      "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=900&q=80",
  },
  brokerage: "Marin & West Estates · Victoria, British Columbia",
  address: "1208 Wharf Street, Victoria, BC V8W 3B9",
  social: {
    instagram: "#",
    facebook: "#",
    linkedin: "#",
  ...
  /* Big-number social proof shown in the stats band + about page. */
  stats: [
    { value: 1.2, prefix: "$", suffix: "B+", label: "In career sales volume" },
    { value: 640, suffix: "+", label: "Families moved" },
    { value: 11, suffix: " days", label: "Avg. on market" },
    { value: 100, suffix: "%", label: "Of list price, on average" },
  ],

  /* Featured slugs (pulled from `listings` below) shown on the home page. */
  featured: ["oceanfront-oak-bay", "heritage-rockland", "modern-cordova-bay"],
};

/* ---------------------------------------------------------------------------
   LISTINGS
   Each listing renders on /listings and at /listing.html?id=<slug>
   Images use Unsplash placeholders — swap `hero` / `gallery` with real photos.
   ------------------------------------------------------------------------- */
window.LISTINGS = [
  {
  ...
  },
  {
    ...
    type: "Estate Acreage",
    blurb:
      "A gated country estate on nearly five acres with vineyard potential and sweeping pastoral views.",
    description:
      "Down a tree-lined drive, this craftsman estate sits amid manicured grounds, fenced paddocks and a spring-fed pond. The vaulted timber-frame great room centres on a stone hearth, and the kitchen opens to a wraparound veranda built for sunsets over the Saanich Peninsula. Outbuildings include a barn and a detached studio — room to grow, garden or simply breathe.",
    features: [
  ...
  },
  {
    ...
    type: "Seaside",
    blurb:
      "A bright seaside home in the heart of Sidney-by-the-Sea — sold in 6 days, over asking.",
    description:
      "A coastal-cool retreat moments from Sidney's waterfront promenade, boutiques and cafés. Sold in six days with multiple offers — a reflection of both the home and the strategy behind it.",
    features: [
...
/* ---------------------------------------------------------------------------
   COMMUNITIES — neighbourhood guides
   ------------------------------------------------------------------------- */
window.COMMUNITIES = [
  {
    name: "Oak Bay",
    ...
    blurb:
      "Tree-lined avenues, heritage homes and the genteel charm of Oak Bay Avenue — Victoria's most established seaside enclave.",
    stat: "Median $2.1M",
    image:
  ...
  },
  {
    ...
    blurb:
      "Stately estates and embassy-row character on the doorstep of the Art Gallery and Craigdarroch Castle.",
    stat: "Median $1.8M",
    image:
  ...
  },
  {
    ...
    blurb:
      "Sandy shores, the Mattick's Farm village and family-friendly streets along the Saanich coastline.",
    stat: "Median $1.6M",
    image:
  ...
  },
  {
    ...
    blurb:
      "A vibrant waterfront promenade, independent bookshops and the gateway to the Southern Gulf Islands.",
    stat: "Median $1.1M",
    image:
...
window.TESTIMONIALS = [
  {
    quote:
      "Elena sold our Oak Bay home for well over asking in under two weeks. Her marketing was simply on another level — the photography, the staging, the story she told about our home. Flawless.",
    name: "James & Priya N.",
    area: "Oak Bay",
  },
  {
    quote:
      "We interviewed three agents. Marin & West were the only ones with a real plan. Calm, data-driven and genuinely kind through a stressful move. We can't recommend them enough.",
    name: "The Whitfield Family",
    area: "Cordova Bay",
  },
  {
    quote:
      "As first-time buyers we felt completely out of our depth. Elena's team guided us through every step and negotiated a price we didn't think was possible. Forever grateful.",
    name: "Daniel & Mei L.",
    area: "Sidney",
  },
  {
    quote:
      "Relocating from overseas, we bought our home before ever setting foot in Victoria. The virtual tours and honest advice made us feel completely confident. They earned a client for life.",
    name: "Sophie & Marc D.",
    area: "Rockland",
  },
];
...
/* ---------------------------------------------------------------------------
   AWARDS / PRESS (logos shown as text marks on the About page)
   ------------------------------------------------------------------------- */
window.AWARDS = [
